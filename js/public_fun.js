...
wsf.translatorModule = {
    ...
    renderList: function(dom){
        ...
        if(!dom.data('renderList')){
            ...
            var active = '';
            langList.forEach(function(tmpId) {
                that.list.forEach(function(v, i){
                    if (tmpId === v.id) {
                        if(that.currentLang === tmpId){
                            active='active';
                            valDom.html(v.name);
                        } else {
                            active = '';
    ...
    load: function(){
        ...
        if(translatorModule.length && window.translate){
            // 设置默认翻译为的语种
            console.log(GData.defaultLang, 'GData.defaultLang');
                                ...
                                case 'online':
                                    (function(){
                                        ...
                                        switch(subItem.type*1){
                                            case 1:
                                                href = 'https://wpa.qq.com/msgrd?v=3&uin='+ subItem.value +'&site=qq&menu=yes';
                                                icon = 'https://xysjs.dlssyht.cn/_nuxt/img/service_qq.f68df07.png'
                                                break;
                                            case 2:
                                                href = 'https://amos.alicdn.com/msg.aw?v=2&uid='+ subItem.value +'&site=cnalichn&s=11&charset=utf-8';
                                                icon = 'https://xysjs.dlssyht.cn/_nuxt/img/service_aliTM.2133809.png'
                                                break;
                                            case 3:
                                                href = 'skype:'+ subItem.value +'?call';
                                                icon = 'https://xysjs.dlssyht.cn/_nuxt/img/service_skype.cac0a74.png'
                                                break;
                                        }
                                        console.log()
